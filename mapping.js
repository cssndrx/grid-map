const mapping = {
  ...
  "Building Automation Systems": [
    ...
    {
      "name": "PermitFlow",
      "description": "PermitFlow is the nation\\'s leading permit application and management platform. We help builders across the country to simplify and speed up the process of obtaining construction permits.",
    ...
    {
      "name": "Solidspac3",
      "description": "Solidspac3 is a technology and services provider for the building construction industry. Our solution creates automated reports that alert field professionals when the site conditions don\u2019t match the plans. Our services team members have expertise in surveying, scanning, BIM, and construction. In addition to our analysis reports, we bring the construction site to the desktop with the BIM, site data and 360\u00ba images available in our web-based application, Spac3.",
      "website": "solidspac3.com",
      "employees": "3",
      "active_jobs": "0"
    },
    {
    ...
    },
    {
      ...
      "description": "Turntide specializes in developing sustainable technologies that drive down energy consumption and operating costs in buildings, agriculture, and electric transport, boosting bottom lines and accelerating a global path to 100% renewable energy. It has developed an efficient electric motor system, based on revolutionary switched reluctancetechnology, managed by advanced cloud software. Its goal is to eliminate the 25% of global electricity consumption that is wasted by legacy electric motors, thus accelerating the world\u2019s transition from fossil fuels and leaving them in the ground where they belong.",
  ...
  "Reduced Food Waste": [
    ...
    {
      "name": "Courial",
      "description": "Developer of a courier application designed to connect couriers with individuals and businesses that need stuff delivered. The company\\'s application uses a handy search engine to directly order anything users want from their favorite stores and let them handle pickup and delivery at their convenience, enabling users to spend time doing what matters most, while they handle all courier-related needs.",
      "website": "courial.com",
      "employees": "9",
      "active_jobs": "1"
    },
    {
      "name": "Edacious",
      "description": "Edacious is a company focused on the verification of food quality, the most important outcome of our agri-food system.",
      "website": "edacious.com",
      "active_jobs": "5"
    },
    {
    ...
    {
      "name": "Kinfield",
      "description": "Kinfield is a startup that brings transparency, sustainability, clean ingredients, and a sense of community to the outdoor product space. It was founded in 2019 and is based in Brooklyn, New York, United States.",
      "website": "kinfield.com",
      "employees": "12",
      "active_jobs": "0"
    },
    {
      "name": "Packfleet",
      "description": "Packfleet is a courier for eCommerce businesses in London.",
      "website": "packfleet.com",
      "employees": "36",
      "active_jobs": "3"
    },
    {
      "name": "Pendulum Systems",
      "description": "Pendulum Systems is a venture-backed AI company that swings into action to solve one of the world\\'s most pressing problems - how to get more from less. Pendulum is the world\u2019s first AI-powered supply chain API that predicts demand, optimizes supply and geolocates - continuously improving on its own.",
      "website": "pendulum.global",
      "employees": "50",
      "active_jobs": "2"
    },
    {
    ...
    {
      "name": "Sweep",
      "description": "Sweep helps businesses track and act on their carbon, so they can become forever companies.\n\nOur data-driven platform, with powerful collaboration features and user-focused design, makes it easy to measure emissions, take action to reduce your carbon footprint, and stay compliant with the latest reporting standards.",
      "website": "sweep.net",
      "employees": "125",
      "active_jobs": "7"
    },
    ...
    {
      "name": "oroeco",
      "description": "It\\'s a confusing time to be an idealist. Life is no longer just \"paper or plastic?\" It\\'s now \"organic, fair trade, low carbon, GMO-free, zero trans fat, dolphin safe, biodegradable, non-toxic, not tested on animals, natural, or local?\" We may only get to elect our representatives once every few years, but we vote with our wallets and our lifestyles every day. How should we decide what to do amidst a tsunami of information overload? Oroeco is founded on the premise that it should be easy, fun and rewarding to track how our everyday purchases, investments, and lifestyle decisions link up to our core values. We started as a group of friends, frustrated by the lack of information out there to help us sort out small improvements from big decisions. We didn\\'t want to be activists or full-time volunteers for a cause, we just wanted to vote with our wallets and how we lived our lives. And we wanted to find fun ways to get our friends, family, and big companies to do the same. So with Oroeco we\\'re creating a way to add everything up. The Oroeco tools will allow you to cut through marketing hype and dynamically track the impacts that you care about based on real data, get personalized suggestions for how you can do more good with less money, and engage in some constructive competition with friends, family, coworkers, and other communities. When you use Oroeco you not only help align your lifestyle with your values, you also encourage your friends and family to do the same. The more we all use Oroeco, the more our collective wallets encourage companies to demonstrate how they\\'re aligning their business practices with our visions for a better tomorrow. In short, at Oroeco we\\'re building you a dashboard for life. We think you have a right to know how your actions and your money intersect with your values and we think you deserve to be rewarded for your efforts to make our world a better place.",
      "website": "oroeco.com",
      "employees": "1",
      "active_jobs": "0"
    },
    {
      "name": "unspun",
      "description": "Unspun is a robotics and digital apparel company building custom jeans for each consumer, on demand. The company\\'s mission is to reduce global carbon emissions by 1% through automated, localized, and intentional manufacturing. The company\\'s technology is currently being realized through our award-winning brand unspun.io (one ofTIME\\'s Best Inventions of 2019), a software B2B platform powering digital customization for multiple large apparel labels, and a National Science Foundation-backed hardware team working on the future of additive and automated apparel production. We\u2019re a fast-moving company powered by Fifty Years, Prelude Ventures, SOSV, and the H&M Foundation.",
      "website": "unspun.io",
      "employees": "56",
      "active_jobs": "3"
    }
  ...
  "Distributed Energy Storage": [
    ...
    {
      "name": "Reach",
      "description": "Reach is a technology company that builds long-range wireless power networks that deliver scalable and resilient energy infrastructure. The company\\'s wireless power solution does for power delivery what Wi-Fi does for data connectivity. The Reach system is built on state-of-the-art, patented technology, including high-efficiency power beaming circuits, network optimization algorithms, and adaptive electromagnetic surfaces, delivering a highly scalable, safe, and easy-to-use power platform. Ideally suited for manufacturing, government, energy, logistics, and retail.",
      "website": "reachpower.com",
      "employees": "38",
      "active_jobs": "9"
    },
    {
  ...
  "Alternative Refrigerants": [
    ...
    {
      "name": "Nuventura",
      "description": "Nuventura developed GIS switchgear that replaces SF6 with air, while at the same time, building on all the advantages of SF6 switchgear.",
      "website": "nuventura.com",
      "employees": "45",
      "active_jobs": "10"
    }
  ],
  ...
  "Perennial Staple Crops": [
    ...
    },
    {
      ...
      "description": "Prolific Machines is a biotech company developing cell technologies to redefine how cells are produced for a sustainable and healthy future. It combines cutting-edge technologies to enable cell production at a new scale. The company was founded in 2020 and is based in San Francisco, California.",
      "website": "prolific-machines.com",
      "employees": "33",
      "active_jobs": "0"
    }
  ],
  ...
  "Reduced Emissions from Existing Technologies": [
    {
      "name": "Noya",
  ...
  "Utility-Scale Energy Storage": [
    ...
    {
      "name": "Rondo Energy",
      "description": "We\\'re hiring!! Rondo is delivering the world\\'s lowest cost zero-carbon industrial heat. The Rondo Heat Battery powers industrial processes with renewable electricity, cutting energy costs and eliminating emissions. We deliver complete solutions to large-scale industrial energy needs worldwide - both as major capital projects and on a Heat as a Service basis. The Rondo Heat Battery provides temperatures up to 1,500\u00b0C, at less than half the cost and twice the efficiency of hydrogen.",
